...
const check = function check() {
    ...
    } else if (numN == 0) document.querySelector(".message").textContent = "\u26D4\uFE0F No number!";
    else if (score > 1) {
        score = score - 1;
        document.querySelector(".score").textContent = `${score}`;
        if (numN < secNum) document.querySelector(".message").textContent = "\uD83D\uDCC9 Too low!";
        else if (numN > secNum) document.querySelector(".message").textContent = "\uD83D\uDCC9 Too high!";
    } else {
...
},{}]},["iL2AH","6rimH"], "6rimH", "parcelRequire5251")
